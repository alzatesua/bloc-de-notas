...
public class main extends JFrame  {
    String textarea_abrir ="";
	String textarea_cerrar="";
	String val2 ="";
	int tamano_fuente= 18;
	...
	public main() {
		...
		String nombre  = "";
	  	addWindowListener(new WindowAdapter() {
				...
				public void windowClosing(WindowEvent e) {
					textarea_cerrar = textArea.getText();
		...
		textArea_1.setFont(new Font(times, Font.BOLD | Font.ITALIC, 18));
		...
		textArea_2.setFont(new Font(Times(), Font.BOLD | Font.ITALIC, tamano_fuente));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(selecion == JFileChooser.APPROVE_OPTION) {
					...
					try (FileReader fr = new FileReader(fichero)){
						...
						textArea_1.setText("Nombre del documento: [ " + a + " ]" + "\n"
						 + "Ubicacion del documento: [ "+ archivo + " ]");
						textarea_abrir = textArea.getText();
						E_lineas(textArea, textArea_2);	
		...
		mntmNewMenuItem_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e){
                 textArea_1.setText(buscar_palabra(textArea.getText()));
		...
		mntmNewMenuItem_3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				int contador =0;
				contador = caracteres(textArea.getText());
				System.out.println(contador);
				if(contador > 0){
					textArea_1.setText(guardar(textArea.getText()));
				}else{
    ...
    public void cerrar(String documento) {
		if (textarea_abrir.equals(textarea_cerrar)){
			System.exit(0);
	...
	public String guardar(String documento) {
		...
		private void E_lineas(JTextComponent input, JTextComponent out) {
			...
			for (int i = 0; i < lineas.length; i++) {
				textoEnumerado.append(" "+(i + 1) + " "+"\n");
			}
	
			out.setText(textoEnumerado.toString());
		}
	 ...
	 * @return
	 */
	static String buscar_palabra(String objeto) {
		boolean bacio = true;
		String entrada;
		String salida;
		String mensaje = "";
